    ...
    <section class="  w-[50%] m-auto mt-[5%] shadow-2xl bg-center bg-no-repeat bg-[url('https://www.herzing.edu/sites/default/files/styles/fp_640_288/public/images/blog/students_study_1.jpg.webp?itok=riENGJSB')] bg-gray-300 rounded-3xl bg-blend-multiply">
        <div class="  px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
            ...
            <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                ...
                <a href="/login" class="w-[20%] m-auto shadow-2xl inline-flex justify-center hover:text-gray-900 items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg border bg-black border-gray hover:bg-gray-100 focus:ring-4 focus:ring-gray-400">
                    Get Started
                </a>  
            </div>
        </div>
